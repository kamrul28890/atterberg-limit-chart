...
def plot_chart(df):
    try:
        ...
        # --- Auto-Save Prompt ---
        save_prompt = messagebox.askyesno("Save Chart", "Would you like to save this chart as PNG?")
        if save_prompt:
        ...
        messagebox.showerror("Plot Error", f"An unexpected error occurred while plotting:\n{str(e)}")
